...
export const sendStateOfficerOtpEmail = async ({ email, otp, name }: SendOtpEmailParams) => {
  try {
    ...
    const subject = "State Officer OTP for LoanSetu Portal";
    const title = "State Officer Login Verification";
    const greeting = name ? `Hello ${name},` : "Hello Officer,";
                ...
                <tr>
                  <td style="padding:24px 24px 8px 24px;">
                    ...
                    <p style="margin:0 0 16px 0; font-size:14px; color:#4b5563; line-height:1.5;">
                      ...
                      <strong>LoanSetu State Officer Dashboard</strong>.  
                      Use the OTP below to verify your identity and proceed with your secure login.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:0 24px 16px 24px;">
                    ...
                    <p style="margin:0 0 8px 0; font-size:13px; color:#6b7280;">
                      ...
                      The LoanSetu team will <strong>never</strong> ask you for this OTP via call, SMS, WhatsApp, or email.
                    </p>
                ...
                <tr>
                  <td style="padding:0 24px 24px 24px; border-top:1px solid #e5e7eb;">
                    <p style="margin:12px 0 4px 0; font-size:11px; color:#9ca3af;">
                      You’re receiving this email because your email address was used for a state officer login attempt on LoanSetu.
                    </p>
    ...
    await emailTransporter.sendMail({
      ...
      subject,
      html,
      text: `LoanSetu State Officer OTP: ${otp}\n\nThis OTP will expire in 5 minutes.\nDo not share it with anyone.\nIf you did not request this login, please ignore this email.`,
    });

    console.log(`State Officer OTP email sent successfully to ${email}`);
    return { message: `State Officer OTP sent to ${email}`, success: true };
  } catch (error) {
    console.error("Error sending state officer OTP email:", error);
