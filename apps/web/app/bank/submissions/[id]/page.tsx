...
export default function SubmissionDetails() {
  ...
  const fetchSubmission = async () => {
    try {
      const response = await fetch(`/api/bank-submission/${params.id}`);
  ...
  if (loading) {
    return (
      ...
      >
        <BankSidebar open={open} setOpen={setOpen} />
    ...
    >
      ...
      <div className="flex flex-1 flex-col overflow-auto">
        <div className="flex w-full flex-col gap-4 rounded-tl-2xl border border-neutral-200 bg-white p-4 md:p-8">
          ...
          <div className="relative bg-gradient-to-r from-orange-600 via-orange-500 to-orange-600 rounded-2xl p-8 text-white shadow-2xl overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-orange-600/50 to-transparent animate-pulse"></div>
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
                <div className="text-center mb-3">
                  <span className="text-sm text-orange-100">AI Decision</span>
                </div>
          ...
          {activeTab === "overview" && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Risk Score */}
              <div className="lg:col-span-1 bg-gradient-to-br from-white to-orange-50/30 rounded-xl shadow-lg border-2 border-orange-100 p-6">
                <h3 className="text-lg font-bold text-neutral-900 mb-6 flex items-center gap-2">
                  <div className="p-2 bg-orange-100 rounded-lg">
                    <IconShieldCheck className="w-6 h-6 text-orange-600" />
                  </div>
                  Risk Assessment
                </h3>
              ...
              <div className="lg:col-span-2 bg-white rounded-xl shadow-lg border border-neutral-200 p-6">
                ...
                {llmReport && (
                  <div className="mt-6 p-4 bg-orange-50 border border-orange-200 rounded-lg">
                    <h4 className="font-semibold text-orange-900 mb-2">AI Summary</h4>
                    <p className="text-sm text-orange-800">{llmReport.summary}</p>
                  </div>
                )}
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-neutral-200 p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {submission.media?.map((media: any, index: number) => (
                    <div
                      key={index}
                      className="group relative aspect-square rounded-xl overflow-hidden bg-gradient-to-br from-neutral-50 to-neutral-100 border-2 border-neutral-200 hover:border-orange-400 hover:shadow-2xl transition-all duration-300 cursor-pointer"
                      ...
                      {media.type === "IMAGE" || media.type === "DOCUMENT" ? (
                        ...
                        <>
                          ...
                          <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                            <div className="bg-orange-600/90 backdrop-blur-sm p-4 rounded-full group-hover:scale-110 transition-transform">
          ...
          {activeTab === "ai-analysis" && (
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-orange-600 to-orange-500 rounded-xl shadow-2xl p-8 text-white">
          ...
          {activeTab === "technical" && (
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-lg border border-neutral-200 p-6">
                <h3 className="text-lg font-bold text-neutral-900 mb-6 flex items-center gap-2">
                  <IconDeviceMobile className="w-6 h-6 text-blue-600" />
                  Device Information
                </h3>
